...
export default function VaccineScheduler(props: VaccineSchedulerProps) {
    ...
    const getSlotsData = () => {
        try {
            ...
            if(!flag){
                setFlag(true);
                fetch(COWIN_URL + '/v2/appointment/sessions/public/findByDistrict?district_id='+selectedDistrict+'&date='+datestring, {headers: {
                    Accept: 'application/json',
                    "Accept-Language": "hi_IN",
                    "user-agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) " +
                        "Chrome/39.0.2171.95 Safari/537.36 "
